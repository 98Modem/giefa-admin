...
const SEARCH_KEYWORDS: Record<string, string> = {
  ...
  "/governance/change-roles": "change roles assign roles appoint chairman treasurer general secretary governance users leadership",
  "/chairman/finance-overview": "change roles assign roles appoint chairman treasurer general secretary governance users leadership",
